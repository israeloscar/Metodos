# ☕ Estudos de Java — Métodos

Repositório com os exercícios de métodos do meu aprendizado de Java.  
...
|---|---|---|
| Fase 1 | Fundamentos de Java | 🟡 Em andamento |
| Fase 2 | POO Avançada e Coleções | ⏳ Pendente |
...
```bash
git clone https://github.com/israeloscar/Metodos.git
```
...
Ou pelo terminal:
```bash
javac src/CalculadoraMetodos.java
java -cp src CalculadoraMetodos
```
